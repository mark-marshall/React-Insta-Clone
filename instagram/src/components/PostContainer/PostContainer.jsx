...
export default function PostContainer({ thumbnail, username, image, likes, comments, timestamp }) {
  return (
    <div className="post-container">
      ...
      <img className="post-reaction-image" alt="heart" src={require('./PostContainerAssets/heart.png')}/>
      <img className="post-reaction-image"  alty="comment" src={require('./PostContainerAssets/comment.png')}/>
