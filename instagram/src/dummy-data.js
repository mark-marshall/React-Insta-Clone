...
const dummyData = [
  {
    ...
    likes: 400,
    timestamp: moment("July 17th 2017, 12:42:40 pm", "MMMM Do YYYY, h:mm:ss a").fromNow(),
    comments: [
      {
        username: "philzcoffee",
        text:
  ...
  },
  {
    ...
    likes: 4307,
    timestamp: moment("July 15th 2017, 03:12:09 pm", "MMMM Do YYYY, h:mm:ss a").fromNow(),
    comments: [
      {
        username: "twitch",
  ...
  },
  {
    ...
    likes: 5306,
    timestamp: moment("July 14th 2017, 10:04:08 am", "MMMM Do YYYY, h:mm:ss a").fromNow(),
    comments: [
      {
        username: "playhearthstone",
        text: "Love this shot!"
